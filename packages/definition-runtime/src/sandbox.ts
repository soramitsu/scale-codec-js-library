...
interface ScaleMap<in out K, in out V> extends Map<K, V> {}
...
interface Msg<in out M> {
  msg: M
  sender: Str
}

declare const Msg: <M>(msg: Msg<M>) => Msg<M>
